...
def main():
    ...
    trained_model = ResNet9.load(models_dir / "ResNet9_1.1987.pth", device=device)
    untrained_model = ResNet9()
    ...
    plot_tsne_subplot(ax1, projected_trained, labels, "Trained (ResNet9_1.1987) - All Classes")
    ...
    plot_tsne_subplot(ax3, projected_trained, labels, "Trained - Automobile Highlighted", highlight_class=automobile_idx)

    ax4 = fig.add_subplot(3, 2, 4, projection="3d")
    plot_tsne_subplot(ax4, projected_untrained, labels, "Untrained - Automobile Highlighted", highlight_class=automobile_idx)

    # Row 3: Frogs highlighted
    ax5 = fig.add_subplot(3, 2, 5, projection="3d")
    plot_tsne_subplot(ax5, projected_trained, labels, "Trained - Frog Highlighted", highlight_class=frog_idx)

    ax6 = fig.add_subplot(3, 2, 6, projection="3d")
    plot_tsne_subplot(ax6, projected_untrained, labels, "Untrained - Frog Highlighted", highlight_class=frog_idx)

    # Add legend to the figure
    handles, legend_labels = ax1.get_legend_handles_labels()
    fig.legend(handles, legend_labels, loc="upper center", ncol=5, fontsize=10,
               bbox_to_anchor=(0.5, 0.98), markerscale=2)

    plt.suptitle("t-SNE 3D Embeddings Comparison: Trained vs Untrained ResNet9",
